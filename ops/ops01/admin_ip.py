...
class IpAdmin(admin.ModelAdmin):
    ...
    fields = ('hostname','display_name', 'ip', 'idc','group', 'belongs_to', 'template_list','custom_services','port', 'os' )
    list_display = ( 'display_name','hostname', 'ip', 'idc',  'port', 'os','belongs_to')
